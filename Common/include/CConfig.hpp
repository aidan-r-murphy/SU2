...
private:
  ...
  *Marker_SobolevBC;                  /*!< \brief Markers in the gradient solver */
  ...
  unsigned short nWA_Options;         /*!< \brief Number of WA options specified. */
...
public:
  ...
  */
  ...
  /*!
   * \brief Get the value of the non-dimensionalized freestream turbulence intensity (For WA Model).

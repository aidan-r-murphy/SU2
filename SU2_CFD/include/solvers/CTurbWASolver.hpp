...
private:
  ...
  /*!
   * \brief Compute R from the wall functions.
...
public:
  ...
  /*!
   * \brief Get the constants for the WA model.
  ...
  /*!
   * \brief Get the value of R at the far-field.
   * \return Value of R at the far-field.
   */
  inline su2double GetR_Inf(void) const override { return Solution_Inf[0]; }

...
void CTurbWASolver::Viscous_Residual(const unsigned long iEdge, const CGeometry* geometry, CSolver** solver_container,
...
su2double CTurbWASolver::GetInletAtVertex(unsigned short iMarker, unsigned long iVertex,
